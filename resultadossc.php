...
<head>
    ...
    <title>Resultados - Superintendencia de Seguridad Comunal</title>
...
<div class="container-fluid">
     ...
     <div class="text-center fs-3">
        <p>Superintendencia de Seguridad Comunal</p>
    </div>
    </div>
    <br>
...
try {
    if (isset($_POST['consulta_ssc'])) {
        $consulta = $_POST['consulta_ssc'];

        if ($consulta === 'hechos_esclarecidos_ssc') {
            $sql = "SELECT id, n_sumario, dep_instructora, caratula, magis_interventor, num_sum_relacionado, cant_allanamientos, cant_aut_detenidos FROM provisorio.hechos_esclarecidos_ssc";
        } elseif ($consulta === 'detenidos_ssc') {
            $sql = "SELECT n_sumario, dni, apellido, nombre, fecha_nac, edad, genero, nacionalidad, domicilio FROM provisorio.detenidos_ssc";
        } else {
